    ...
    <div id="main-container">
        <form action="" id="main-form" enctype="multipart/form-data">
            ...
            <div class="group clearfix">
                ...
                <div class="subgroup">
                    <div class="subgroup-title">County</div>
                    <input type="text" class="subgroup-input" value="" name="County">
                </div>
                <div class="subgroup">
                ...
                <div class="subgroup no-margin-left">
                    <div class="subgroup-title">Street number</div>
                    <input type="text" class="subgroup-input" value="" name="StreetNumber">
                </div>
            </div>
